 ...
 * {@link sql.QueryParser}.
 */
public interface QueryListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link sql.QueryParser#query}.
	 * @param ctx the parse tree
	 */
	void enterQuery(@NotNull QueryParser.QueryContext ctx);
	/**
	 * Exit a parse tree produced by {@link sql.QueryParser#query}.
	 * @param ctx the parse tree
	 */
	void exitQuery(@NotNull QueryParser.QueryContext ctx);
	/**
	 * Enter a parse tree produced by {@link sql.QueryParser#select}.
	 * @param ctx the parse tree
	 */
	void enterSelect(@NotNull QueryParser.SelectContext ctx);
	/**
	 * Exit a parse tree produced by {@link sql.QueryParser#select}.
	 * @param ctx the parse tree
	 */
	void exitSelect(@NotNull QueryParser.SelectContext ctx);
	/**
	 * Enter a parse tree produced by {@link sql.QueryParser#colname}.
	 * @param ctx the parse tree
	 */
	void enterColname(@NotNull QueryParser.ColnameContext ctx);
	/**
	 * Exit a parse tree produced by {@link sql.QueryParser#colname}.
	 * @param ctx the parse tree
	 */
	void exitColname(@NotNull QueryParser.ColnameContext ctx);
	/**
	 * Enter a parse tree produced by {@link sql.QueryParser#tablename}.
	 * @param ctx the parse tree
	 */
	void enterTablename(@NotNull QueryParser.TablenameContext ctx);
	/**
	 * Exit a parse tree produced by {@link sql.QueryParser#tablename}.
	 * @param ctx the parse tree
	 */
