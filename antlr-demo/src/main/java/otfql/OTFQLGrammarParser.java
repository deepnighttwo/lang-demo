...
public class OTFQLGrammarParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "CompareOprt", "BoolOprt", "'='", "'>'", "'<'", "'>='", "'<='", 
		"'!='", "'not'", "'and'", "'or'", "'select'", "','", "'from'", "'where'", 
		"'as'", "'('", "')'", "'.'", "'['", "']'", "INT", "LiteralVar", "ID", 
		"WS"
	};
	public static final int
		...
		try {
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(57); match(DOT);
					setState(58); propName();
					}
					} 
				}
				setState(63);
	...
	public final PropNameContext propName() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(66); match(LBRACK);
				setState(67); match(INT);
				setState(68); match(RBRACK);
				}
				break;
			}
		}
	...
	public final BoolExprsContext boolExprs() throws RecognitionException {
		...
		try {
			...
			while (_la==BoolOprt) {
				{
				{
				setState(72); match(BoolOprt);
				setState(73); boolExpr(0);
				}
				}
				setState(78);
				_errHandler.sync(this);
	...
	public final BoolExprContext boolExpr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(81); boolExpr(3);
				}
				break;

			case 2:
				{
				setState(82); propFullName();
				setState(83); match(CompareOprt);
				setState(84); propFullName();
				}
				break;

			case 3:
				{
				setState(86); match(LiteralVar);
				setState(87); match(CompareOprt);
				setState(88); propFullName();
				}
				break;

			case 4:
				{
				setState(89); propFullName();
				setState(90); match(CompareOprt);
				setState(91); match(LiteralVar);
				}
				break;

			case 5:
				{
				setState(93); match(LiteralVar);
				setState(94); match(CompareOprt);
				setState(95); match(LiteralVar);
				}
				break;
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(103); match(BoolOprt);
					setState(104); boolExpr(2);
					}
					} 
				}
				setState(109);
	...
	public static final String _serializedATN =
		...
		"\3\f\3\r\3\r\3\r\2\16\2\4\6\b\n\f\16\20\22\24\26\30\2\2t\2\32\3\2\2\2"+
		"\4\37\3\2\2\2\6(\3\2\2\2\b+\3\2\2\2\n.\3\2\2\2\f8\3\2\2\2\16:\3\2\2\2"+
		"\20G\3\2\2\2\22I\3\2\2\2\24f\3\2\2\2\26p\3\2\2\2\30r\3\2\2\2\32\33\5\4"+
		"\3\2\33\35\5\6\4\2\34\36\5\b\5\2\35\34\3\2\2\2\35\36\3\2\2\2\36\3\3\2"+
		"\2\2\37 \7\16\2\2 %\5\n\6\2!\"\7\17\2\2\"$\5\n\6\2#!\3\2\2\2$\'\3\2\2"+
		"\2%#\3\2\2\2%&\3\2\2\2&\5\3\2\2\2\'%\3\2\2\2()\7\20\2\2)*\7\32\2\2*\7"+
		"\3\2\2\2+,\7\21\2\2,-\5\22\n\2-\t\3\2\2\2./\5\f\7\2/\60\7\22\2\2\60\61"+
		"\7\32\2\2\61\13\3\2\2\2\629\5\16\b\2\63\64\7\32\2\2\64\65\7\23\2\2\65"+
		"\66\5\16\b\2\66\67\7\24\2\2\679\3\2\2\28\62\3\2\2\28\63\3\2\2\29\r\3\2"+
		"\2\2:?\5\20\t\2;<\7\25\2\2<>\5\20\t\2=;\3\2\2\2>A\3\2\2\2?=\3\2\2\2?@"+
		"\3\2\2\2@\17\3\2\2\2A?\3\2\2\2BH\7\32\2\2CD\7\32\2\2DE\7\26\2\2EF\7\30"+
		"\2\2FH\7\27\2\2GB\3\2\2\2GC\3\2\2\2H\21\3\2\2\2IN\5\24\13\2JK\7\4\2\2"+
		"KM\5\24\13\2LJ\3\2\2\2MP\3\2\2\2NL\3\2\2\2NO\3\2\2\2O\23\3\2\2\2PN\3\2"+
		"\2\2QR\b\13\1\2RS\7\13\2\2Sg\5\24\13\2TU\5\16\b\2UV\7\3\2\2VW\5\16\b\2"+
		"Wg\3\2\2\2XY\7\31\2\2YZ\7\3\2\2Zg\5\16\b\2[\\\5\16\b\2\\]\7\3\2\2]^\7"+
		"\31\2\2^g\3\2\2\2_`\7\31\2\2`a\7\3\2\2ag\7\31\2\2bc\7\23\2\2cd\5\24\13"+
		"\2de\7\24\2\2eg\3\2\2\2fQ\3\2\2\2fT\3\2\2\2fX\3\2\2\2f[\3\2\2\2f_\3\2"+
		"\2\2fb\3\2\2\2gm\3\2\2\2hi\6\13\2\3ij\7\4\2\2jl\5\24\13\2kh\3\2\2\2lo"+
		"\3\2\2\2mk\3\2\2\2mn\3\2\2\2n\25\3\2\2\2om\3\2\2\2pq\7\31\2\2q\27\3\2"+
